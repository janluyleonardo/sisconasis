    ...
    <div class="row">
      <div class="col-md-8 col-lg-8 col-sm-8 mx-auto">
        <div class="card shadow-xl">
          ...
          <div class="card-body">
            <form class="needs-validation" action="{{ route('players.store') }}" method="post"
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <input type="text" class="form-control" name="Player_document" id="Player_document"
                    value="{{ old('Player_document') }}">
                ...
                <div class="col-md-8">
                  <input type="text" class="form-control" name="Player_email" id="Player_email"
                    value="{{ old('Player_email') }}">
                  @error('Player_email')
                    <div class="col-md-12 text-center text-danger mb-3"><strong>{{ $message }}</strong></div>
                  @enderror
                </div>
                <div class="col-md-4">
                  <input type="text" class="form-control" name="Player_phone" id="Player_phone"
                    value="{{ old('Player_phone') }}">
                  @error('Player_phone')
                    <div class="col-md-12 text-center text-danger mb-3"><strong>{{ $message }}</strong></div>
                  @enderror
                </div>
                ...
                <div class="col-md-3">
                  <input type="text" class="form-control" name="Player_age" id="Player_age"
                    value="{{ old('Player_age') }}">
                  @error('Player_age')
                    <div class="col-md-12 text-center text-danger mb-3"><strong>{{ $message }}</strong></div>
                  @enderror
                </div>
                <div class="col-md-3">
                  <input type="text" class="form-control" name="Player_number" id="Player_number"
                ...
                <div class="col-md-6">
                  <strong><label for="Player_photo" class="form-label">Equipo al que pertenece el
                      jugador</label></strong>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12 mt-2  text-center">
                  <input class="btn btn-secondary btn-sm sombra" type="submit" name="save_Player"
                    value="{{ __('Create Player') }}">
                </div>
              </div>
            </form>
          </div>
